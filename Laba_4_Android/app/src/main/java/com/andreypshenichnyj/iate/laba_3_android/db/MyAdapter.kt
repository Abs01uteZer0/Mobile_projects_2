...
import com.andreypshenichnyj.iate.laba_3_android.EditActivity
import com.andreypshenichnyj.iate.laba_3_android.R
...
class MyAdapter(listMain: ArrayList<ListItem>, contextM: Context) :
    ...
    fun removeItem(pos: Int, dbManager: MyDbManager) {
        dbManager.removeItemFromDb(listArray.get(pos).id.toString())
